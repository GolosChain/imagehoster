    ...
    request(id, api_id, method, params = [], callback = null) {
        ...
        return this.connect_promise.then(() => {
            ...
            if (this.update_rpc_request_status_callback) {
                ...
                promise
                    .then(() =>
                        this.update_rpc_request_status_callback({ event: 'END', id, method })
                    )
                    .catch(() =>
                        this.update_rpc_request_status_callback({ event: 'ERROR', id, method })
                    );
            }
            return promise;
        });
